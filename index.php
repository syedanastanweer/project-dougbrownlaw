										...
										<div class="col-md-6">
											<div class="input-group flex-nowrap">
												<span class="input-group-text"><img
														src="assets/images/douglas/icons/name-icon.svg"
										...
										<div class="col-md-12 gy-md-4">
											<div class="input-group flex-nowrap">
												...
												<input type="email" name="email" class="form-control"
													aria-describedby="email" pattern="[^ @]*@[^ @]*"
										...
										<div class="col-md-12 gy-md-4">
											<div class="input-group flex-nowrap">
												<span class="input-group-text" id="addon-wrapping"><img
														...
														alt="Hancock Publishers Phone"
														title="Hancock Publishers Phone"></span>
												<input type="number" name="phone" class="form-control"
													aria-describedby="phone" placeholder="Phone Number" required="">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12 gy-md-4">
											<div class="input-group flex-nowrap">
												<span class="input-group-text align-items-start"
													id="addon-wrapping"><img
														src="assets/images/douglas/icons/msg-icon.svg"
														style="margin-top: 15px;" title="Hancock Publishers Message"
				...
				<div class="row y-middle">
					...
					<div class="col-lg-6">
						<div class="copyright text-lg-start text-center ">
							<p>Copyright © 2022 Solvency. Designed By <a href="https://Devsdesign.com" target="blank">
									Devsdesign</a></p>
						</div>
					</div>
				</div>
		...
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="col-md-4 ft-left">
					...
					<p><img src="assets/images/douglas/footer-1.png" alt=""></p>
				</div>
				<!-- Middle Column -->
